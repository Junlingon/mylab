    ...
    <div id="left-container">
        <div id="left-chart-nav">
            <nav class="scrollactive-nav">
                <ul>
                    <li>
                        <a id="left-chart-nav-line" href="/Motorcade"
                            class="left-chart-nav-link scrollactive-item">
                            <span class="chart-icon">
                                 <svg width="175px" height="138px"
                                    viewBox="0 0 175 138" version="1.1" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <span class="chart-name">车队</span>
                        </a>
                    </li>
                    <li><a id="left-chart-nav-bar" href="/Element"
                            class="left-chart-nav-link scrollactive-item">
                            <span class="chart-icon">
                                <svg width="175px" height="138px"
                                    viewBox="0 0 175 138" version="1.1" xmlns="http://www.w3.org/2000/svg"
