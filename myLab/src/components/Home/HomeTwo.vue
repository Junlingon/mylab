<template>
  <section>
    <div class="content">
      ...
      <div class="header">
        <div class="names">
          <span class="name-en">Achievement</span
...
.header .paging .vertical-divider {
  width: 0.3%;
  height: 100%;
...
.wrapper:hover .content-underline {
  background-color: #1c16df;
}
.wrapper:hover .content-desc,
.wrapper:hover .content-name {
  color: #1c16df;
}
</style>